...
const Map<String, Map<String, String>> _localizedTexts =
  ...
  'auth.welcome_title': {'zh': '欢迎来到地球Online', 'en': 'Welcome to Earth Online'},
  'auth.sign_in': {'zh': '登录', 'en': 'Sign In'},
  'auth.sign_up': {'zh': '注册', 'en': 'Sign Up'},
  'auth.email_label': {'zh': '邮箱', 'en': 'Email'},
  'auth.email_hint': {'zh': '请输入邮箱地址', 'en': 'Enter your email'},
  'auth.send_button': {'zh': '发送验证码', 'en': 'Send Code'},
  'auth.send_button_resend': {'zh': '{seconds}秒后重发', 'en': 'Resend in {seconds}s'},
  'auth.code_label': {'zh': '验证码', 'en': 'Verification Code'},
  'auth.code_hint': {'zh': '请输入验证码', 'en': 'Enter verification code'},
  'auth.primary_button.signin': {'zh': '继续登录', 'en': 'Continue'},
  'auth.primary_button.signup': {'zh': '创建账号', 'en': 'Create Account'},
  'auth.explore': {'zh': '游客体验', 'en': 'Explore as Guest'},
  'auth.edit_email': {'zh': '修改邮箱', 'en': 'Edit Email'},
  'auth.invalid_email': {'zh': '请输入有效的邮箱地址', 'en': 'Please enter a valid email'},
  'auth.invalid_code': {'zh': '请输入6位验证码', 'en': 'Enter 6-digit code'},
  'auth.code_sent.signin': {'zh': '验证码已发送', 'en': 'Code sent'},
  'auth.code_sent.signup': {'zh': '验证码已发送', 'en': 'Code sent'},
  'auth.verify_success.signin': {'zh': '登录成功', 'en': 'Signed in'},
  'auth.verify_success.signup': {'zh': '注册成功', 'en': 'Account created'},
  'auth.verify_failed': {'zh': '验证失败', 'en': 'Verification failed'},
  'auth.guest_success': {'zh': '以游客身份进入', 'en': 'Entered as guest'},
  'auth.guest_failed': {'zh': '游客登录失败: {error}', 'en': 'Guest login failed: {error}'},
  'auth.language.chinese': {'zh': '中文', 'en': 'Chinese'},
  'auth.language.english': {'zh': '英文', 'en': 'English'},
  ...
  'memory.create.title': {'zh': '记录一段记忆', 'en': 'Record a Memory'},
  'memory.create.hint': {'zh': '写下你想记住的事…', 'en': 'Write something to remember…'},
  'memory.create.submit': {'zh': '保存记忆', 'en': 'Save Memory'},
  'memory.create.success': {'zh': '记忆已保存', 'en': 'Memory saved'},
  'memory.time.minutes_ago': {'zh': '{n}分钟前', 'en': '{n}m ago'},
  'memory.time.hours_ago': {'zh': '{n}小时前', 'en': '{n}h ago'},
  'memory.time.days_ago': {'zh': '{n}天前', 'en': '{n}d ago'},
  'memory.filter.title': {'zh': '筛选记忆', 'en': 'Filter Memories'},
  'memory.filter.date_range': {'zh': '时间范围', 'en': 'Date Range'},
  'memory.filter.date_all': {'zh': '全部时间', 'en': 'All Time'},
  'memory.filter.date_7d': {'zh': '最近 7 天', 'en': 'Last 7 Days'},
  'memory.filter.date_30d': {'zh': '最近 30 天', 'en': 'Last 30 Days'},
  'memory.filter.kind': {'zh': '记忆类型', 'en': 'Memory Type'},
  'memory.filter.kind_all': {'zh': '全部类型', 'en': 'All Types'},
  'memory.filter.apply': {'zh': '应用筛选', 'en': 'Apply Filter'},
  'memory.filter.reset': {'zh': '重置', 'en': 'Reset'},
  'memory.detail.title': {'zh': '记忆详情', 'en': 'Memory Detail'},
